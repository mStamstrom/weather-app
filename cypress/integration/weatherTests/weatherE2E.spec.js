describe('weather e2e tests', () => {
  ...
  it('when selecting new weather in forecast, detailed information about weather is shown', () => {
    ...
    cy.get('.current-weather .current-temperature').then(($beforeTemperature) => {
      ...
      cy.get('.day-container:nth-child(4) .weather-list-item:nth-child(3)').click();
      ...
      onBeforeLoad(contentWindow) {
        cy.stub(window, 'fetch', () => {
          return new Promise(resolve => resolve({
            city: { name: 'test' },
            list: [{"dt":1551808800,"main":{"temp":-10,"temp_min":-7.64,"temp_max":-6.37,"pressure":1003.04,"sea_level":1003.04,"grnd_level":997.85,"humidity":67,"temp_kf":-1.27},"weather":[{"id":800,"main":"Clear","description":"clear sky","icon":"01n"}],"clouds":{"all":0},"wind":{"speed":2.94,"deg":7.5004},"snow":{"3h":0.012},"sys":{"pod":"n"},"dt_txt":"2019-03-05 18:00:00"},
